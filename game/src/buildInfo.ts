export interface NwdBuildInfo {
  readonly sourceSha: string; readonly frontendSha: string; readonly deployCommit: string; readonly repositoryProvider: 'github'|'gitlab'|'unknown'; readonly branch: string; readonly buildId: string; readonly builtAt: string;
