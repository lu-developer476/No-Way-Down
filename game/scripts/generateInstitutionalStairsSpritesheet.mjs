...
const outputSvgPath = path.resolve(scriptDir, '../public/assets/tilesets/institutional_stairs_spritesheet.svg');
const outputJsonPath = path.resolve(scriptDir, '../public/assets/tilesets/institutional_stairs_spritesheet_coords.json');
